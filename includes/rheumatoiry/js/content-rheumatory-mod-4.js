     ...
     */
      ...
      function eduObjGooglehBarQ1() {
          ...
          var data = google.visualization.arrayToDataTable([
              ['I am not interested', '' ],
              ['I see the need BUT…', 0.090 ],
              ['I would like to learn more', 0.145],
              ['I am ready to try this', 0.381],
              ['I am doing this consis-tently', 0.200],
          ...
          mydiv = $("#edu-obj-google-hBar-m4-q1");
          chart = new google.visualization.ComboChart(mydiv[0]);
          chart.draw(data, {
            height: 300, seriesType: 'bars',
            legend: {position: 'none'},
      ...
      function speakerGoogleDonutQ1pt1() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('edu-obj-google-donut-m4-q1-pt-1'));
      ...
      function speakerGoogleDonutQ1pt2() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('edu-obj-google-donut-m4-q1-pt-2'));
      ...
      function eduObjGooglehBarQ2() {
          ...
          var data = google.visualization.arrayToDataTable([
              ['I am not interested', '' ],
              ['I see the need BUT…', 0.090 ],
              ['I would like to learn more', 0.272],
              ['I am ready to try this', 0.431],
              ['I am doing this consis-tently', 0.204],
          ...
          mydiv = $("#edu-obj-google-hBar-m4-q2");
          chart = new google.visualization.ComboChart(mydiv[0]);
          chart.draw(data, {
            height: 300, seriesType: 'bars',
            legend: {position: 'none'},
      ...
      function speakerGoogleDonutQ2pt1() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('edu-obj-google-donut-m4-q2-pt-1'));
      ...
      function speakerGoogleDonutQ2pt2() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('edu-obj-google-donut-m4-q2-pt-2'));
      ...
      function eduObjGooglehBarQ3() {
          ...
          var data = google.visualization.arrayToDataTable([
              ['I am not interested', '' ],
              ['I see the need BUT…', 0.066 ],
              ['I would like to learn more', 0.177],
              ['I am ready to try this', 0.533],
              ['I am doing this consis-tently', 0.222],
          ...
          mydiv = $("#edu-obj-google-hBar-m4-q3");
          chart = new google.visualization.ComboChart(mydiv[0]);
          chart.draw(data, {
            height: 300, seriesType: 'bars',
            legend: {position: 'none'},
      ...
      function speakerGoogleDonutQ3pt1() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('edu-obj-google-donut-m4-q3-pt-1'));
      ...
      function speakerGoogleDonutQ3pt2() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('edu-obj-google-donut-m4-q3-pt-2'));
     ...
     // Question 4
      ...
      function programGooglePieQ4() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('program-google-pie-m4-q4'));
      ...
      function programGooglePieQ5() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('program-google-pie-m4-q5'));
      ...
      function programGooglePieQ6() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('program-google-pie-m4-q6'));
      ...
      function speakerGoogleDonutQ9() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('speaker-google-donut-m4-q9'));
      ...
      function speakerGoogleDonutQ10() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('speaker-google-donut-m4-q10'));
