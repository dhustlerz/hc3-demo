   ...
   $sidebar_output.='<li class="xn-logo">';
      ...
      $sidebar_output.='<li class="xn-profile">';
          ...
          $sidebar_output.='<div class= "profile">';
              ...
              $sidebar_output.='<div class="profile-data">';
                  $sidebar_output.='<div class="profile-data-name"><span>username</span><a href="#" class="n-mb-control padding-left-12 color-fff" data-box="#n-mb-signout"><span class="fa fa-gear"></span></a></div>';
      ...
      $sidebar_output.='<li class="">';
          ...
          $sidebar_output.='<li class="menu xn-openable">';
            $sidebar_output.='<a href="#"><span class="fa  fa-file-text-o"></span><span class="xn-text">Program Evaluation</span></a>';
                        $sidebar_output.='<ul>';
                            // $sidebar_output.='<li >';
                            ...
                            $sidebar_output.='<li class="n-xn-openable">';
                            $sidebar_output.='<a href="overview.php">Rheumatory</a>';
                              $sidebar_output.='<ul>';
                               // $sidebar_output.='<li class="menu"><a href="program-evaluation.php?p=rheumatory&t=all">All Programs</a></li>';
